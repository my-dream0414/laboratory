<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="设备类型" width="250" align="center" >
        <template slot-scope="scope">
          {{ scope.row.property.toString() }}
        </template>
      </el-table-column>
      <el-table-column label="设备名称" width="500" align="center">
        <template slot-scope="scope">
          {{scope.row.project}}
        </template>
      </el-table-column>
    ...
    >
      <el-form :model="editForm" label-width="200px">
        ...
        <el-form-item label="设备类型选择">
          <el-select v-model="editForm.property" multiple placeholder="请选择设备类型">
            <el-option
